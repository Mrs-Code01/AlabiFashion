      ...
      <section>
        <div className='cat-width'>
          <div className='cat-top'>
            <h1>Men Native Product Category</h1>
            <div>
          ...
          <div className='cat-flex'>
            <div className='cat-item'>
              ...
              <Link to='/mennative1'>View All</Link>
            </div>
            <div className='cat-item'>
              <div>
                <img src={img2} alt="" />
              ...
              <Link to='/mennative2'>View All</Link>
            </div>
            <div className='cat-item'>
              <div>
                <img src={img3} alt="" />
              ...
              <Link to='/mennative3'>View All</Link>
            </div>
            <div className='cat-item'>
              <div>
                <img src={img4} alt="" />
              ...
              <Link to='/mennative4'>View All</Link>
            </div>
          </div>
        </div>
      </section>
