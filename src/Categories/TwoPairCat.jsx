            ...
            <section>
                <div className='cat-width'>
                    <div className='cat-top'>
                        <h1>Two Pair Wears Product Category</h1>
                        <div>
                    ...
                    <div className='cat-flex'>
                        <div className='cat-item'>
                            ...
                            <Link to='/twopair1'>View All</Link>
                        </div>
                        <div className='cat-item'>
                            <div>
                                <img src={img2} alt="" />
                            ...
                            <Link to='/twopair2'>View All</Link>
                        </div>
                        <div className='cat-item'>
                            <div>
                                <img src={img3} alt="" />
                            ...
                            <Link to='/twopair3'>View All</Link>
                        </div>
                        <div className='cat-item'>
                            <div>
                                <img src={img4} alt="" />
                            ...
                            <Link to='/twopair4'>View All</Link>
                        </div>
                    </div>
                </div>
            </section>
